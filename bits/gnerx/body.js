...
export default function Body(tags, cfg, tab) {
  ...
  // Empty .bg-wrap keeps its ::after vignette overlay on top of .time-bg (injected by theme.js).
  van.add(body, htm(tags, undefined, "div", { class: "bg-wrap" }));

  const content = ["header","sections", "navs", "main", "footer"],
    nth = content.length;
